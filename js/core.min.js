 ...
 */
function pageTransition(n) {
    n = n || {}, n.page = n.page || $("#page"), n.animDelay = n.animDelay || 500, n.animDuration = n.animDuration || 1e3, n.animIn = n.animIn || "fadeIn", n.animOut = n.animOut || "fadeOut", n.onReady = n.onReady || null, n.onAnimated = n.onAnimated || null, n.conditions = n.conditions || function(n, a) {
        return !/(\#|callto:|tel:|mailto:|:\/\/)/.test(a)
    }, setTimeout(function() {
        n.onReady && n.onReady(n), n.page.addClass(n.animIn + " animated"), n.page.css("animation-duration", n.animDuration + "ms"), n.page[0].addEventListener("animationstart", function() {
            setTimeout(function() {
                n.page.removeClass(n.animIn), n.onAnimated && n.onAnimated(n)
            }, n.animDuration)
        })
    }, n.animDelay), $("a").click(function(a) {
        var t = a.currentTarget.getAttribute("href");
        if (n.conditions(a, t)) {
            a.preventDefault(), console.warn("[page transition]");
            var e = this.href;
            n.page.removeClass(n.animIn).addClass(n.animOut), setTimeout(function() {
                window.location = e, /firefox/i.test(navigator.userAgent) && setTimeout(function() {
                    n.page.removeClass(n.animOut)
                }, 1e3), /safari/i.test(navigator.userAgent) && !/chrome/i.test(navigator.userAgent) && n.page.removeClass(n.animOut)
            }, n.animDuration)
        }
    })
}
